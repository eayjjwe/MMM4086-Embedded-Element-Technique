...
EE_in = "thDweave_F_EE_refined3.inp"; #f_1
H_in = "thDweave_M_EE_refined.inp"; #f_2

INP_out = "thDWeave_refined3.inp"; #f_3
...
with open(INP_out,"a") as f_3, open(Int_inp,"r") as f_5:
    ...
    #Copying *Element to ***ORIENTATIONS*** from INP1
Part = "*Element"
End_Part = "*** ORIENTATIONS ***"
...
with open(EE_in, "r") as f_1, open(INP_out, "a") as f_3:
    ...
    #adding orientation for part 1
with open(INP_out, "a") as f_3:
    f_3.write("*Orientation, Name=TexGenOrientations, Definition=coordinates\n**ax ay az, bx by bz, cx cy cz\n1, 0, 0, 0, 1, 0, 0, 0, 0\n")

    #Adding Element sets from INP1
Element_Set = "*** ELEMENT SETS ***"
End_elset = "*** MATERIALS ***"

with open(EE_in, "r") as f_1, open(INP_out,"a") as f_3:
    elset_section_started = False
    for line in f_1:
        if Element_Set in line:
            elset_section_started = True
        elif elset_section_started and End_elset in line:
            break
        if elset_section_started:
            f_3.write(line)
...
with open(INP_out,"a") as f_3:
    ...
    #copying node to ***ORIENTATIONS*** from INP2
Part = "*Node"
End_Part = "*** ELEMENT SETS ***"
...
#adding orientation for part 2
with open(INP_out, "a") as f_3:
    f_3.write("*Orientation, Name=TexGenOrientations, Definition=coordinates\n**ax ay az, bx by bz, cx cy cz\n1, 0, 0, 0, 1, 0, 0, 0, 0\n")

    #Adding Element sets from INP2
Element_Set = "*** ELEMENT SETS ***"
End_elset = "*** MATERIALS ***"
...
G12_e2 = 1/(2*C_ort_e2[3,3]);
G13_e2 = 1/(2*C_ort_e2[4,4]);
G23_e2 = 1/(2*C_ort_e2[5,5]);
